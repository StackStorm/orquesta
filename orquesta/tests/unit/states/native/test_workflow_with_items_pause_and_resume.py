...
class WorkflowConductorWithItemsPauseResumeTest(test_base.WorkflowConductorWithItemsTest):
    ...
    def test_pause_workflow_with_single_item(self):
        test_cases = [
            (statuses.RUNNING, statuses.PAUSING, statuses.PAUSING),
            (statuses.SUCCEEDED, statuses.SUCCEEDED, statuses.PAUSED),
            (statuses.PENDING, statuses.PAUSED, statuses.PAUSED),
            (statuses.PAUSING, statuses.PAUSING, statuses.PAUSING),
            (statuses.RESUMING, statuses.PAUSING, statuses.PAUSING),
        ...
        for ac_ex_status, tk_ex_status, wf_ex_status in test_cases:
            self.assert_pause_workflow_with_single_item(ac_ex_status, tk_ex_status, wf_ex_status)

    def assert_pause_workflow_with_items(self, ac_ex_statuses, tk_ex_status, wf_ex_status):
        wf_def = """
        version: 1.0
    ...
    def test_pause_workflow_with_items_action_running(self):
        ...
        for ac_ex_statuses, tk_ex_status, wf_ex_status in test_cases:
            self.assert_pause_workflow_with_items(ac_ex_statuses, tk_ex_status, wf_ex_status)
